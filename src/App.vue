...
<div class="px-10 mx-auto container align-middle">
      <div class="grid grid-cols-2 gap-2">
        <div class="shadow rounded-lg py-3 px-5 bg-white">
          <div class="flex flex-row justify-between items-center">
            <div>
              <h6 class="text-2xl">Balance</h6>
              <h4 class="text-black text-4xl font-bold text-left">563 USDT</h4>
            </div>
            <div>
              <svg
          ...
          <div class="text-left flex flex-row justify-start items-center">
            ...
            <p><span class="text-teal-500 font-bold">34%</span> in 7 days</p>
          </div>
        </div>
        <div class="shadow rounded-lg py-3 px-5 bg-white">
          <div class="flex flex-row justify-between items-center">
            <div>
              <h6 class="text-2xl">Win / Loss</h6>
              <h4 class="text-black text-4xl font-bold text-left">168.9 USDT</h4>
            </div>
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
	...
	<span class="bubble 20x"></span>
          ...
          <input type="text" name="entry" id="entry" placeholder="Entry price" v-model="input_entry" />
...
<body class="antialiased font-sans bg-gray-200">
	...
	<div class="list" id="todo-list">
                <h2 class="text-2xl font-semibold leading-tight">Trading history</h2>
            </div>
